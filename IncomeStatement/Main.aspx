...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <script  type="text/javascript" src="/IncomeStatement/WebData/BundleResult/Main/IS_20191117_min_v1.js"></script>
        <link rel="stylesheet" href="/IncomeStatement/WebData/BundleResult/Main/IS_20191117_min_v1_CSS.css" />
<!--
        <script  type="text/javascript" src="http://localhost:8080/JsFile/Internal/Main/IS_20191117_min_v1.js"></script>
        <link rel="stylesheet" href="http://localhost:8080/JsFile/Internal/Main/IS_20191117_min_v1_CSS.css" />
-->
    </head>
    <body>
        <div id="vue-instance">
